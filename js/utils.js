/**
 * 工具函数模块
 * 包含通用工具函数、常量定义、数据处理函数等
 */

// ==================== 常量定义 ====================

const PROJECT_STAGES = [
    { key: 'tracking', name: '跟踪', defaultDuration: 30, color: '#f59e0b' },
    { key: 'contract', name: '签约', defaultDuration: 30, color: '#3b82f6' },
    { key: 'procedure', name: '手续', defaultDuration: 120, color: '#8b5cf6' },
    { key: 'construction', name: '建设', defaultDuration: 150, color: '#ec4899' },
    { key: 'operation', name: '运营', defaultDuration: 365, color: '#10b981' }
];
...
const REGION_DATA = {
    ...
    '广东省': {
        ...
        '东莞市': ['东城街道', '南城街道', '万江街道', '莞城街道', '石碣镇', '石龙镇', '茶山镇', '石排镇', '企石镇', '横沥镇', '桥头镇', '谢岗镇', '东坑镇', '常平镇', '寮步镇', '樟木头镇', '大朗镇', '黄江镇', '清溪镇', '塘厦镇', '凤岗镇', '大岭山镇', '长安镇', '虎门镇', '厚街镇', '沙田镇', '道滘镇', '洪梅镇', '麻涌镇', '望牛墩镇', '中堂镇', '高埗镇', '松山湖管委会', '东莞港', '东莞生态园', '东莞滨海湾新区'],
        '中山市': ['石岐区街道', '东区街道', '火炬开发区街道', '西区街道', '南区街道', '五桂山街道', '小榄镇', '黄圃镇', '民众镇', '东凤镇', '东升镇', '古镇镇', '沙溪镇', '坦洲镇', '港口镇', '三角镇', '横栏镇', '南头镇', '阜沙镇', '南朗镇', '三乡镇', '板芙镇', '大涌镇', '神湾镇', '坦洲镇'],
        '潮州市': ['湘桥区', '潮安区', '饶平县'],
    ...
    '海南省': {
        ...
        '儋州市': ['那大镇', '和庆镇', '南丰镇', '大成镇', '雅星镇', '兰洋镇', '光村镇', '木棠镇', '海头镇', '峨蔓镇', '三都镇', '王五镇', '白马井镇', '中和镇', '排浦镇', '东成镇', '新州镇', '洋浦经济开发区', '华南热作学院'],
    ...
    '甘肃省': {
        ...
        '平凉山': ['崆峒区', '泾川县', '灵台县', '崇信县', '庄浪县', '静宁县', '华亭市'],
...
/**
 * 计算多点的中心点
 * @param {Array} points - 点数组 [{latitude, longitude}]
 * @returns {Object} 中心点 {latitude, longitude}
 */
...
function getCitiesByProvince(province) {
    ...
    return Object.keys(REGION_DATA[province]);
}
...
function validateProject(data) {
    ...
    if (data.scale && data.scale.designCapacity && data.scale.designCapacity <= 0) {
        errors.push('设计规模必须大于0');
    }
